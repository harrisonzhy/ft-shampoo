...
Curvature state replication using erasure coding for FDSP Distributed Shampoo by Meta Research. Below is the information provided at the [`facebookresearch/optimizers`](https://github.com/facebookresearch/optimizers/tree/main) repository.
